 ...
 *
 * @help
 * This plugin are only enabled when the game is in Play or Battle Test mode.
 *
 * - Debug Menu Icon will be in the upper right corner of the map when enabled.
 * - Right click on an event to alter it.
 * - F9 in Map: Open a mini debug menu;
 * - F9 in Battle: Open a mini debug menu and in 'Quick' menu, quickly win/lose
 * a battle, recover all, on/off variance for damage,enable 100% state rates or
 * apply normal state rates.
 *
 * ============================================================================
 * Introduction
 * ============================================================================
 ...
 *
 * Field Debug menu will appear when you right click on the map. If you right
 ...
 * to quickly win a battle, lose a battle, recover everything for the party, 
 * enable/disable variance for damage, enable 100% state rates or apply normal
 * state rates (doing so will make all states applied through skills using
 * traits will have a 100% success rate, removing the frustration of having to
 * keep casting the skill over and over again to test the effects of a state).
 *
 * ----------------------------------------------------------------------------
 * Spawn Options
 * ----------------------------------------------------------------------------
