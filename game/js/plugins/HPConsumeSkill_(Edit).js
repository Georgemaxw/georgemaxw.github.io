...
// Window_SkillList.prototype.costWidth = function() { return this.textWidth('0000000000000'); };
...
Window_SkillList.prototype.drawSkillCost = function(skill, x, y, width) {
 if (this._actor.skillHpCost(skill) > 0) {
  ...
  if (this._actor.skillMpCost(skill) === 0 && this._actor.skillTpCost(skill) === 0) {
    ...
    this.changeTextColor(this.textColor(24)); 
    this.drawText(this._actor.skillHpCost(skill), x - 51, y, width, 'right');
  ...
  this.changeTextColor(this.textColor(24)); 
    this.drawText(this._actor.skillHpCost(skill), x - 102, y, width, 'right');
    this.changeTextColor(this.mpCostColor());
