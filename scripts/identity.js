...
<li><a onclick="nav_menu_options(this)">Link 2</a>
    ...
    <div>
        <ul>
            <li><a href="#"><img src="../framework/images/ex_landscape.png" alt=" "><span>Link 2.1</span></a></li>
            <!--<li><a href="#"><span><img src="../framework/images/ex_textImg_2_1.svg" alt="" class="textImg_size">Link 2.2</span></a></li>-->
            <li><a href="#"><img src="../framework/images/ex_landscape.png" alt=" "><span>Link 2.3</span></a></li>
            <!--<li><a href="#">Link 2.4</a></li>-->
            <li><a href="#"><img src="../framework/images/ex_landscape.png" alt=" "><span>Link 2.5</span></a></li>
        </ul>
    </div>
...
<li><a onclick="nav_menu_options(this)">L3</a>
    ...
    <div>
        <ul class="nav_compact_subOptions_textBelow">
            <li><a href="#"><img src="../framework/images/ex_landscape.png" alt=" "><span>Link 3.1</span></a></li>
            <!--<li><a href="#"><span><img src="../framework/images/ex_textImg_2_1.svg" alt="" class="textImg_size">Link 3.2</span></a></li>-->
            <li><a href="#"><img src="../framework/images/ex_landscape.png" alt=" "><span>Link 3.3</span></a></li>
            <!--<li><a href="#">Link 3.4</a></li>-->
            <li><a href="#"><img src="../framework/images/ex_landscape.png" alt=" "><span>Link 3.5</span></a></li>
        </ul>
    </div>
...
<li><a onclick="nav_menu_options(this)">L4</a>
    ...
    <div>
        <ul class="nav_expanded_subOptions_h nav_expanded_subOptions_textBelow">
            <li><a href="#"><img src="../framework/images/ex_portrait.png" alt=" "><span>Link 4.1</span></a></li>
            <!--<li><a href="#"><span><img src="../framework/images/ex_textImg_2_1.svg" alt="" class="textImg_size">Link 4.2</span></a></li>-->
            <li><a href="#"><img src="../framework/images/ex_portrait.png" alt=" "><span>Link 4.3</span></a></li>
           <!-- <li><a href="#">Link 4.4</a></li>-->
            <li><a href="#"><img src="../framework/images/ex_portrait.png" alt=" "><span>Link 4.5</span></a></li>
            <li><a href="#"><img src="../framework/images/ex_portrait.png" alt=" "><span>Link 4.6</span></a></li>
        </ul>
    </div>
...
<li><a onclick="nav_menu_options(this)">L5</a> 
    ...
    <div>
        <ul class="nav_expanded_subOptions_h nav_subOptions_textBelow">
            <li><a href="#"><img src="../framework/images/ex_portrait.png" alt=" "><span>Link 5.1</span></a></li>
            <!--<li><a href="#"><span><img src="../framework/images/ex_textImg_2_1.svg" alt="" class="textImg_size">Link 5.2</span></a></li>-->
            <li><a href="#"><img src="../framework/images/ex_portrait.png" alt=" "><span>Link 5.3</span></a></li>
           <!-- <li><a href="#">Link 5.4</a></li>-->
            <li><a href="#"><img src="../framework/images/ex_portrait.png" alt=" "><span>Link 5.5</span></a></li>
            <li><a href="#"><img src="../framework/images/ex_portrait.png" alt=" "><span>Link 5.6</span></a></li>
        </ul>
    </div>
...
<li><a onclick="nav_menu_options(this)"><img src="../framework/images/ex_textImg_2_1.svg" alt="" class="textImg_size">L7</a>

    <div>
        <ul>
            <li><a href="#"><span><img src="../framework/images/ex_textImg_2_1.svg" alt="" class="textImg_size">Link 7.1</span></a></li>
            <li><a href="#"><span><img src="../framework/images/ex_textImg_2_1.svg" alt="" class="textImg_size">Link 7.2</span></a></li>
            <li><a href="#"><span><img src="../framework/images/ex_textImg_2_1.svg" alt="" class="textImg_size">Link 7.3</span></a></li>
            <!--<li><a href="#">Link 7.4</a></li>
            <li><a href="#"><img src="../framework/images/ex_landscape.png" alt="" class="nav_poster_margins"><span>Link 7.5</span></a></li> 
            <li><a href="#"><img src="../framework/images/ex_landscape.png" alt="" class="nav_poster_margins"><span>Link 7.6</span></a></li>-->
        </ul>
    </div>
...
<li><a aria-label="Hide bar"><img src="../framework/images/icon_headerNav-hide.svg" alt="Header-nav button"></a></li>
</ul>
`
...
// var bg_nav_selector = 'url(../../../framework/images/bg_nav_selector.png)  center/100% 100%' // VÍNCULO: Váriável CSS
...
<address>
    ...
    <!--<p>Follow us on:</p>-->
        ...
        <ul class="footer-icons">
            <li><a href="mailto:support@company.com.br"><img src="../framework/images/icon_mail.svg" alt=""></a></li>  
            <li><a href="#"><img src="../framework/images/icon_youtube.svg" alt=""></a></li> 
            <li><a href="#"><img src="../framework/images/icon_twitch.svg" alt=""></a></li>
            <li><a href="#"><img src="../framework/images/icon_instagram.svg" alt=""></a></li>
            <li><a href="#"><img src="../framework/images/icon_facebook.svg" alt=""></a></li>  
            <li><a href="#"><img src="../framework/images/icon_twitter.svg" alt=""></a></li> 
        </ul>
